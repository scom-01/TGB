...
namespace SCOM.UI
{
    public class ItemDetailUI : MonoBehaviour
    {
        ...
        [SerializeField] private UIItemState UI_ItemState;
        ...
        public void SetInit(StatsItemSO _item, GameObject GO)
        {
            ...
            switch (UI_ItemState)
            {
                case UIItemState.Current:

                    break;
                case UIItemState.Old:

                    break;
                case UIItemState.Detected:
                    //SetUI(GameManager.Inst.StageManager.player.Inventory.CheckDetectedItem);
                    break;
                default:
                    break;
            }
